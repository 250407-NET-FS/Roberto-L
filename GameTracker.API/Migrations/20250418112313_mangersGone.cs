...
{
    /// <inheritdoc />
    public partial class mangersGone : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameConsoles_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checkouts_GameConsoles_GameConsoleId",
                        column: x => x.GameConsoleId,
                        principalTable: "GameConsoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Checkouts_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Checkouts_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_GameConsoleId",
                table: "Checkouts",
                column: "GameConsoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_GameId",
                table: "Checkouts",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_WorkerId",
                table: "Checkouts",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_GameConsoles_StoreId",
                table: "GameConsoles",
                column: "StoreId");
